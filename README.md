...
- [x] [Keycloak](./services/security/keycloak/compose.yml) - Open-source identity and access management solution. ([project link](https://github.com/keycloak/keycloak))
...
- [x] [Kutt](./services/misc/kutt/compose.yml) - URL shortener service. ([project link](https://github.com/thedevs-network/kutt))
...
- [x] [Mealie](./services/misc/mealie/compose.yml) - Recipe management and meal planning application. ([project link](https://github.com/mealie-recipes/mealie))
